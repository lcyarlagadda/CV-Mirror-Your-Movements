...
from mirroryourmovements.models.unet import UNet3DConditionModel
from mirroryourmovements.data.hdvila import HDVilaDataset
from mirroryourmovements.pipelines.pipeline_mirroryourmovements import MirrorYourMovementsPipeline
from mirroryourmovements.util import save_videos_grid, ddim_inversion
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    validation_pipeline = MirrorYourMovementsPipeline(
    ...
    if accelerator.is_main_process:
        ...
        pipeline = MirrorYourMovementsPipeline.from_pretrained(

...
from inference_mirroryourmovements import merge_config_then_run
import sys
...
with gr.Blocks(css='style.css') as demo:
    ...
    <h2 style="font-weight: 450; font-size: 1rem; margin: 0rem">
                  ...
                  <!-- Github link -->
                  <span class="link-block">
                    [<a href="https://github.com/mayuelala/MirrorYourMovements" target="_blank"
                    class="external-link ">
                    <span class="icon">
    ...
    Alternatively, try our GitHub <a href=https://github.com/mayuelala/MirrorYourMovements> code  </a> on your GPU.
    </p>""")
